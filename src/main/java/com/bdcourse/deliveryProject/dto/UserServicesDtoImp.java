...
import com.bdcourse.deliveryProject.model.vo.PartOfListVo;
...
public class UserServicesDtoImp implements UserServicesDto {
    ...
    public PartOfList<StoreVo> getStores(String name, String address) {
        String selectQuery = " select new com.bdcourse.deliveryProject.model.vo.StoreVo(s.id,s.address,s.subjectProduct,s.storeName,s.status,s.products,s.regionEntity) " +
                "from StoreEntity s ";
